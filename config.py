...
COMPANIES_FILE = os.path.join(BASE_DIR, "companies.json")
RESUME_CACHE_FILE = os.path.join(BASE_DIR, "resume_cache.json")
SENT_JOBS_CACHE_FILE = os.path.join(BASE_DIR, "sent_jobs_cache.json")
UPLOADS_DIR = os.path.join(BASE_DIR, "uploads")
...
# Don't re-email a job to the same recipient again within this many days,
# even if it still shows up in a fresh search. After this many days, it's
# treated as new again (it may be a different opening, or worth a reminder).
SENT_JOB_EXPIRY_DAYS = 30